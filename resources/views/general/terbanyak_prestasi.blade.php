...
<section id="services" class="services" style="margin-top: -30px;">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Sekolah SD Dengan Prestasi Terbanyak</h2>
        ...
        <div class="card" style="background-image: url('{{asset('imageUpload/sekolah/'.$sekolah['foto'])}}');" data-aos="fade-up" data-aos-delay="100">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <?php $user = \App\Prestasi::where('id_sekolah', $sekolah['id_sekolah'])->get(); ?>
                <h5 class="card-title" style="float: right;"><i class="bi bi-trophy"></i> {{count($user)}}</h5>
              </div>
            </div>
          </div>
        </div>
...
<section id="services" class="services" style="margin-top: -30px;">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      <h2>Sekolah SMP Dengan Prestasi Terbanyak</h2>
      <p>Segera Daftarkan Diri Kamu Sebelum Pendaftaran Ditutup!</p>
    </div>
        ...
        <div class="card" style="background-image: url('{{asset('imageUpload/sekolah/'.$smp['foto'])}}');" data-aos="fade-up" data-aos-delay="100">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <?php $user = \App\Prestasi::where('id_sekolah', $smp['id_sekolah'])->get(); ?>
                <h5 class="card-title" style="float: right;"><i class="bi bi-trophy"></i> {{count($user)}}</h5>
              </div>
            </div>
