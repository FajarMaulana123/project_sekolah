...
<body>
	...
	<div class="row geocoder">
		...
		<div class="col-md-6">
			<form method="post" name="maps" action="{{ url('update-lokasi-sekolah/'.$nama.'/'.Crypt::encrypt($id_sekolah)) }}" enctype="multipart/form-data"  role="form" >
				@csrf
				<table>
			  		<tr><td>Latlang</td> 
			   		<td> <input type="text" name='latlang' id='latlang' disabled value="{{$sekolah->latitude}} {{$sekolah->longitude}}"></td></tr>
			  	</table>
			  	<input type="hidden" name='latitude' id='latitude' >
			  	<input type="hidden" name='longitude' id='longitude' >
			  	<input type="hidden" name='lat' id='lat' value="{{$sekolah->latitude}}">
			  	<input type="hidden" name='lng' id='lng' value="{{$sekolah->longitude}}">
