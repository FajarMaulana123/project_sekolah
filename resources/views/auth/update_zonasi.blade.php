...
<div class="wrapper fadeInDown">
  <div id="formContent">
    <div id="formFooter">
      <a class="underlineHover" style="color: grey">Titik lokasi sudah di atur!</a>
    </div>
    ...
    <label style="margin-top: 10px; text-align: left;"><h5 style="font-family: 'Open Sans', sans-serif; margin-top: 20px;"><b>Update titik lokasi?</b></h5></label><br>
